  ...
  $(document).ready(function () {
    ...
    if ($("header").hasClass("sticky")) {
      $("header.sticky")
        .clone(true)
        .addClass("cloned")
        .insertAfter("header.sticky")
        .removeClass("header-transparent text-white");
      ...
      function mmenuInit() {
        if ($(window).width() <= "1024") {
          ...
          $("#main-menu")
            .clone()
            .addClass("mmenu-init")
            .prependTo("#main-mobile-nav")
            .removeAttr("id")
            .removeClass("navbar-nav mx-auto")
            .find("li")
            .removeAttr("class")
            .find("a")
            .removeAttr("class data-toggle aria-haspopup aria-expanded")
    ...
    if ($("#fullscreen-slider").length > 0) {
      ...
      tpj(document).ready(function () {
        if (tpj("#fullscreen-slider").revolution == undefined) {
          ...
          revapi24 = tpj("#fullscreen-slider")
            .show()
            .revolution({
              sliderType: "standard",
